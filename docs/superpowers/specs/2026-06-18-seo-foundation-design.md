...
2. **Peaks SEO manifest** — `frontend/src/app/seo/peaks.manifest.json`
...
- `frontend/src/app/seo/peaks.manifest.json`
...
- `frontend/package.json` (`@angular/ssr`, build scripts for sitemap)
