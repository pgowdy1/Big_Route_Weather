...
2. If uncommitted changes exist, auto-commit to the current branch with a descriptive message (never to `dev` or `main` directly — if currently on either, stop and ask the user where the changes belong)
3. Push to remote
